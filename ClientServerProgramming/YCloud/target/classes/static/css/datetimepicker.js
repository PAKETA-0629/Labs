        ...
        return this.each(function () {
            ...
            elem.on('click', function () {
                ...
                function changeDate() {
                    ...
                    $div.unbind('click',submitDateForm());


                }
                function submitDateForm() {
                    dateIsSubmitted= true;
                    if (sent === "true"){
                        document.forms["date_picker_form"].submit();
                    }
                    if (masterIsSubmitted === true && treatmentIsSubmitted === true) {
                        document.forms["date_picker_form"].submit();
                    }
                }
...
// fa-caret-down
var dateIsSubmitted = true;
var masterIsSubmitted = false;
var treatmentIsSubmitted= false;
var sent;

function submitMaster() {
    masterIsSubmitted = true;
    if (sent === "true"){
        document.forms["date_picker_form"].submit();
    }
        document.forms["date_picker_form"].submit();
